...
import static javacv.Helper.toBufferedImage;
import static javacv.Helper.toMatPoint3f;
...
//        MatVector imagePointsMatVect = matVevts[1];
        Point3fVectorVector objectPointsMatVect = new Point3fVectorVector(matVevts[0]);
        Point2fVectorVector imagePointsMatVect = new Point2fVectorVector(matVevts[1]);
...
//                    map1, map2); // the x and y mapping functions
            // TODO 替换上边代码
            opencv_imgproc.convertMaps(
                    _cameraMatrix, // computed camera matrix
                    _distortionCoeffs, // computed distortion matrix
                    map1, map2 ,// camera matrix to generate undistorted
                    CV_32FC1); // the x and y mapping functions
